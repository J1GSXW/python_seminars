...
def find_indices_and_values_in_range(lst, min_val, max_val):
    indices_values = [(i, val) for i, val in enumerate(lst) if min_val <= val <= max_val]
    return indices_values

lst1 = [-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7]
result = find_indices_and_values_in_range(lst1, 2, 10)
print(result)
