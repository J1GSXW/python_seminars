...
def calculate_score(word, language):
    score = 0
    if language == '1':
        ...
        letter_scores = {'А': 1, 'В': 1, 'Е': 1, 'И': 1, 'Н': 1, 'О': 1, 'Р': 1, 'С': 1, 'Т': 1,
...
language = input('Введите язык:\nВведите "1", если английский,\nВведите "2", если русский\n:')
score = calculate_score(word, language)
